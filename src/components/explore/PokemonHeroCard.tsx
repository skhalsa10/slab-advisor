...
export default function PokemonHeroCard({ href = '/browse/pokemon' }: PokemonHeroCardProps) {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl border border-border bg-gradient-to-br from-orange-50 via-white to-amber-50 transition-all duration-300 hover:border-orange-300 hover:shadow-md">
        ...
        <div className="relative flex items-center justify-between p-6 md:p-8">
          ...
          <div className="flex-shrink-0 ml-4">
            <svg
              className="h-5 w-5 text-muted-foreground transition-all duration-200 group-hover:text-orange-500 group-hover:translate-x-0.5"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
