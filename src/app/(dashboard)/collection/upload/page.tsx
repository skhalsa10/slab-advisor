...
export default function UploadPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-grey-900">Upload Card Photos</h1>
        <p className="mt-1 text-sm text-grey-600">
          Upload front and back photos of your card for AI-powered grading and identification
        </p>
      </div>
